...
const generateAssistantAnswer = async ({ historyRows, question }) => {
  ...
  const chat = geminiClient.chats.create({
    ...
    config: {
      ...
      systemInstruction: `You are a professional software engineering assistant.
...
If a user asks anything unrelated to software or technology, politely refuse and say:

"I only assist with software and technology-related topics."

Rules:
- Always provide accurate technical explanations.
- Prefer practical examples and clean code.
...
- Never answer non-technical questions.`,
    },
